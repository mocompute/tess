...
struct tess_type *tess_type_create_user_type(allocator *, char const *name, struct tess_type **fields,
                                             char const **field_names, u16 n) mallocfun;

struct tess_type *tess_type_prim(tess_type_tag); // only primitives
